...
\endfirsthead
\caption*{Продолжение таблицы \ref{t:common:opts}}\\\hline
\multicolumn{1}{|c|}{Опция}&\multicolumn{1}{c|}{Описание}\\\hline
\endhead
...
\multicolumn{1}{|c|}{Опция}&\multicolumn{1}{c|}{Описание}\\\hline
\endfirsthead
\caption*{Продолжение таблицы \ref{t:eskdtext:opts}}\\\hline
\multicolumn{1}{|c|}{Опция}&\multicolumn{1}{c|}{Описание}\\\hline
\endhead
...
\multicolumn{1}{|c|}{Опция}&\multicolumn{1}{c|}{Описание}\\\hline
\endfirsthead
\caption*{Продолжение таблицы \ref{t:eskdgraph:opts}}\\\hline
\multicolumn{1}{|c|}{Опция}&\multicolumn{1}{c|}{Описание}\\\hline
\endhead
...
\multicolumn{1}{|c|}{Опция}&\multicolumn{1}{c|}{Описание}\\\hline
\endfirsthead
\caption*{Продолжение таблицы \ref{t:eskdtab:opts}}\\\hline
\multicolumn{1}{|c|}{Опция}&\multicolumn{1}{c|}{Описание}\\\hline
\endhead
...
\multicolumn{1}{|c|}{Опция}&\multicolumn{1}{c|}{Описание}\\\hline
\endfirsthead
\caption*{Продолжение таблицы \ref{t:eskdplain:opts}}\\\hline
\multicolumn{1}{|c|}{Опция}&\multicolumn{1}{c|}{Описание}\\\hline
\endhead
